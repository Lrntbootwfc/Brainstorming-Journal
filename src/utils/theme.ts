...
export function getThemeConfig(theme?: Partial<PaperThemePreference>): ThemeConfig {
  ...
  if (isDark) {
    return {
      ...
      bg: '#111215',
      cardBg: 'rgba(24, 25, 30, 0.72)',
      sidebarBg: '#14151a',
      border: 'rgba(255, 255, 255, 0.1)',
      chipBg: 'rgba(35, 37, 46, 0.7)',
      chipText: '#e2e8f0',
      activeNavBg: 'rgba(35, 37, 46, 0.8)',
      activeNavText: preset.accent || '#2dd4bf',
      primaryBtnClass: 'bg-teal-500 hover:bg-teal-400 text-stone-950 font-bold shadow-xs',
      lightBadgeClass: 'bg-stone-800/80 text-teal-300 border-stone-700',
      activeTabClass: 'bg-stone-800/90 text-white shadow-xs border border-stone-700',
      calendarStampBg: 'rgba(35, 37, 46, 0.7)',
      calendarStampText: '#e2e8f0',
      paperBg: '#111215',
      paperCardBg: 'rgba(24, 25, 30, 0.72)',
  ...
  return {
    ...
    activeNavBg: 'rgba(255, 255, 255, 0.85)',
    ...
    paperBg: paper.bg,
    paperCardBg: 'rgba(255, 255, 255, 0.78)',
